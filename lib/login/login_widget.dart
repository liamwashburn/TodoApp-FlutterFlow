...
class _LoginWidgetState extends State<LoginWidget>
  ...
  void initState() {
    ...
    _model.signupPassowrdTextController ??= TextEditingController();
    _model.signupPassowrdFocusNode ??= FocusNode();
                ...
                child: Column(
                  ...
                  children: [
                    ClipRRect(
                      ...
                      child: Image.asset(
                        'assets/images/ChatGPT_Image_Feb_9,_2026,_06_25_59_PM.png',
                        width: 2300.0,
                        fit: BoxFit.contain,
                      ),
                    ),
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        ...
                                        child: TextFormField(
                                          controller: _model
                                              .signupPassowrdTextController,
                                          focusNode:
                                              _model.signupPassowrdFocusNode,
                                          autofocus: false,
                                          enabled: true,
                                          textInputAction: TextInputAction.next,
                                          obscureText:
                                              !_model.signupPassowrdVisibility,
                                          decoration: InputDecoration(
                                            isDense: true,
                                            labelStyle:
                                                FlutterFlowTheme.of(context)
                        ...
                        if (_model.tabBarCurrentIndex == 0)
                          FFButtonWidget(
                            onPressed: () async {
                              ...
                              GoRouter.of(context).prepareAuthEvent();
                              if (_model.signupPassowrdTextController.text !=
                              ...
                              final user =
                                ...
                                _model.signupPassowrdTextController.text,
                              );
                              if (user == null) {
                                return;
                              }
